...
- Online instructions index:  
  https://microsoftlearning.github.io/mslearn-fabric/Instructions/Labs/  [oai_citation:0‡Microsoft Learning](https://microsoftlearning.github.io/mslearn-fabric/?utm_source=chatgpt.com)  
- GitHub repo (instructions + assets):  
  https://github.com/MicrosoftLearning/mslearn-fabric  [oai_citation:1‡GitHub](https://github.com/MicrosoftLearning/mslearn-fabric?utm_source=chatgpt.com)  

You’ll reuse the **`sales.csv`** dataset and related materials that appear in:

- Lab “Create a Microsoft Fabric Lakehouse” (`01-lakehouse`)  [oai_citation:2‡Microsoft Learning](https://microsoftlearning.github.io/mslearn-fabric/Instructions/Labs/01-lakehouse.html)  
- Lab “Load data into a warehouse using T-SQL” (`06a-data-warehouse-load`)  [oai_citation:3‡Microsoft Learning](https://microsoftlearning.github.io/mslearn-fabric/Instructions/Labs/06a-data-warehouse-load.html)  
...
1. Open a browser and go to the Fabric home page:  
   `https://app.fabric.microsoft.com/home?experience=fabric`  [oai_citation:4‡Microsoft Learning](https://microsoftlearning.github.io/mslearn-fabric/Instructions/Labs/01-lakehouse.html)  
...
4. Create a new workspace:
   ...
   2. Name it exactly:  
      `DP700-ContosoMobility-Capstone`
...
5. In this workspace, create the **lakehouse**:
   ...
   4. Leave “Lakehouse schemas (Public Preview)” disabled (as in Lab `01-lakehouse`).  [oai_citation:5‡Microsoft Learning](https://microsoftlearning.github.io/mslearn-fabric/Instructions/Labs/01-lakehouse.html)  
...
### Goal
Download the **same Contoso sales dataset** used in labs `01-lakehouse` and `06a-data-warehouse-load` and store it as a raw file in the lakehouse.  [oai_citation:6‡Microsoft Learning](https://microsoftlearning.github.io/mslearn-fabric/Instructions/Labs/01-lakehouse.html)  
...
1. `sales.csv` – downloaded from the dp-data GitHub repo:
   ...
   - URL (as used in official labs):  
     `https://raw.githubusercontent.com/MicrosoftLearning/dp-data/main/sales.csv`  [oai_citation:7‡Microsoft Learning](https://microsoftlearning.github.io/mslearn-fabric/Instructions/Labs/01-lakehouse.html)  
...
2. Optional helper snippet file for SQL later (from mslearn-fabric repo):
   ...
   - `01-Snippets.txt`  
     `https://github.com/MicrosoftLearning/mslearn-fabric/raw/main/Allfiles/Labs/01/Assets/01-Snippets.txt`  [oai_citation:8‡Microsoft Learning](https://microsoftlearning.github.io/mslearn-fabric/Instructions/Labs/01-lakehouse.html)  
...
- A **notebook** (PySpark)
- Optional **Data Wrangler** operations (similar to lab “Preprocess data with Data Wrangler in Microsoft Fabric”).  [oai_citation:9‡Microsoft Learning](https://microsoftlearning.github.io/mslearn-fabric/Instructions/Labs/08b-data-science-preprocess-data-wrangler.html?utm_source=chatgpt.com)  
...
4.3 Create a view pointing to the lakehouse staging/silver table
	5.	In the same instructions page 06a-data-warehouse-load, under the same section, there is an example CREATE VIEW Sales.Staging_Sales AS SELECT * FROM [<your lakehouse name>].[dbo].[staging_sales];  ￼
	6.	In your warehouse:
...
Steps
	...
	•	Sales.Dim_Customer
	•	Sales.Dim_Item
	3.	Name the semantic model:
ContosoMobility_SalesModel.
	4.	Confirm creation.
